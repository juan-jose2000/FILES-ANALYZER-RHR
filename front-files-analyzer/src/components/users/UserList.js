...
export const UserList = () => {
    ...
    const count = useSelector(state => state.user.persons.count);
    ...
    useEffect(() => {
        dispatch(getAllUsers({ limit: pagination }));
    }, [pagination]);
    ...
    return (
        <section className="main-section-wrapper without-padding-top user-list">
            <div className="content-wrapper">
                ...
                <Pagination pagination={pagination} count={count} handleChange={handlePagination} />
                </div>
            </div>
        </section>
    );
